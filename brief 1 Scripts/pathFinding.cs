...
public class pathFinding : MonoBehaviour
{
    ...
    private turnTowards turnTowardsTarget;
    private turntowardsSpanw turntoSpawn;
    ...
    void Start()
    {
        ...
        turnTowardsTarget = GetComponent<turnTowards>();
        turntoSpawn = GetComponent<turntowardsSpanw>();
    }
    ...
    {
        if (collison.gameObject.CompareTag("target"))
        {
            pathFind.enabled = false;
            spawn.enabled = true;
            turnTowardsTarget.enabled = false;
            turntoSpawn.enabled = true;
        }
    }
}
